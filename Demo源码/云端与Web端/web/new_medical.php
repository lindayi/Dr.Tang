...
<body>
    ...
    <div class="content">
		...
		<?php
			...
			{
				mysql_query("INSERT INTO medicalhistory(phonenum, content) VALUES ('".$_SESSION["phonenum"]."' , '".$_POST["content"]."')");
				echo "		<div class=\"alert alert-success\">病历保存成功！</div>";
        	}
		?>
			<div class="row">
				<form action="new_medical.php" method="post" role="form">
					<fieldset>
						<legend>病历内容</legend>
						<div class="form-group">
							<ul class="breadcrumb">
								<li>患者电话：<?php echo $_SESSION["phonenum"];?> <span class="divider"></span></li>
								<li>病历创建日期：<?php echo date("y年m月d日",time());?> <span class="divider"></span></li>
							</ul>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<button type="submit" class="btn btn-primary btn-lg">保存病历</button>
						</div>
					</fieldset>
				</form>
			</div>
