    ...
    <div class="content">
        ...
        <div id="pad-wrapper">
        	<table class="table table-striped">
				...
				<tbody>
				<?php
					$result = mysql_query("SELECT * FROM record WHERE phonenum = ".$_SESSION["phonenum"]." ORDER BY time DESC");
					while($row = mysql_fetch_array($result))
					{
						...
						echo "</th><th>".$row["value"]."</th><th>".$row["food"]."</th><th>".$row["sport"]."</th><th>".$row["medicine"]."</th></tr>\n";
					}
				?>
				</tbody>
			</table>
