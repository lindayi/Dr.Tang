...
import com.example.doctortang.Bluetooth.ServerOrCilent;
        ...
        disconnectButton.setOnClickListener(new OnClickListener()
        {
            ...
            public void onClick(View arg0)
            {
                ...
                if(Bluetooth.serviceOrCilent == ServerOrCilent.CILENT)
                {
                    ...
                    if(Bluetooth.serviceOrCilent == ServerOrCilent.SERVICE)
                    {
                        shutdownServer();
                    }
    ...
    private Handler LinkDetectedHandler=new Handler()
    {
        ...
        public void handleMessage(final Message msg)
        {
            ...
            if(msg.what == 1)
            {
                ...
                final String ftemp=(String) msg.obj;
                TimerTask task=new TimerTask()
                {
                    ...
                    public void run()
                    {
                        Thread t=new Thread()
                        {
                            public void run()
                            {
                                Intent intent=new Intent(chatActivity.this, UpRecordActivity.class);
                                intent.putExtra("value", ftemp);
